...
DIRECT_URL="postgresql://postgres:$senhaEncoded@db.vedrmtowoosqxzqxgxpb.supabase.co:5432/postgres"
...
Write-Host "Arquivo .env configurado completamente!"
Write-Host "DATABASE_URL: Transaction Pooler (IPv4)"
Write-Host "DIRECT_URL: Direct connection (para migrations)"
