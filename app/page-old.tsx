...
function CategoryShowcase() {
  const categories = [
    ...
    },
    {
      ...
      slug: 'iluminacao',
      image:
        'https://images.unsplash.com/photo-1524484485831-a92ffc0de03f?q=80&w=600&auto=format&fit=crop',
...
function WhyUsSection() {
  const reasons = [
    ...
    },
    {
      ...
      desc: 'Frota própria para entregas em Parapuã e região. Seu pedido na obra em 24h ou 48h.',
    },
    {
      icon: <Users className="w-7 h-7 text-red-600" />,
      title: 'Assessoria Técnica',
      desc: 'Equipe de especialistas prontos para calcular e orientar o seu projeto de construção.',
    },
    {
    ...
    },
    {
      ...
      desc: 'Envie sua lista de materiais pelo WhatsApp e receba um orçamento completo em minutos.',
    },
    {
      icon: <CreditCard className="w-7 h-7 text-red-600" />,
      title: 'Condições Especiais',
      desc: 'Até 12x sem juros no cartão, boleto parcelado, PIX com desconto e condições especiais para obras.',
    },
  ];
      ...
      <div className="relative bg-slate-950 rounded-[2rem] overflow-hidden p-10 md:p-16">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col gap-4 shrink-0">
            <a
              href="https://wa.me/5518998145495?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento."
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-500 leading-relaxed">
            Amplo espaço com diversas soluções para o seu projeto. Toque e sinta a qualidade dos
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: <Phone className="w-4 h-4 text-red-600" />, text: '(18) 99814-5495' },
            ].map((item, i) => (
