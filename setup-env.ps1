...
DATABASE_URL="postgresql://postgres.vedrmtowoosqxzqxgxpb:2TLgRvRHOOVCyo7M@aws-0-us-east-1.pooler.supabase.com:6543/postgres?pgbouncer=true"
...
Write-Host "Arquivo .env criado com sucesso em: $envPath"
