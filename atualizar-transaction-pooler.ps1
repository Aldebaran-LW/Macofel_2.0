# Atualizar .env com Transaction Pooler correto
$envPath = Join-Path $PSScriptRoot ".env"

$senhaEncoded = "LW_Digital_Forge%2F123"

$envContent = @"
DATABASE_URL="postgresql://postgres.vedrmtowoosqxzqxgxpb:$senhaEncoded@aws-1-us-east-2.pooler.supabase.com:6543/postgres"
...
Write-Host "Arquivo .env atualizado com Transaction Pooler!"
Write-Host "Host: aws-1-us-east-2.pooler.supabase.com:6543"
Write-Host "IPv4 compatível: Sim"
